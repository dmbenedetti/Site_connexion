<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_imprensa.master" AutoEventWireup="true" CodeFile="noticias.aspx.cs" Inherits="noticias" %>
...
<asp:ListView ID="ListView1" runat="server" DataKeyNames="id_conteudo" DataSourceID="ds_paginas">
            ...
            <ItemTemplate>
                ...
                <table><tr><td>
                <a href="noticias_detail.aspx?id=<%# Eval("id_conteudo") %>"><img src="images/noticias/<%# Eval("imagem") %>" width="85" height="80" style="float:left;margin-right:20px;"/></a>
                </td><td>
                <%# string.Format("{0:dd/MM/yyyy}", Eval("dt_conteudo"))%>
                <h3><a href="noticias_detail.aspx?id=<%# Eval("id_conteudo") %>">
