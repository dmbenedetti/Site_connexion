...
public partial class noticias : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        metatags = (from a in cnDor.TB_CONTEUDO_METATAGS where a.id_hospital == idHosp && a.ds_pagina == "releases.aspx" select a).FirstOrDefault();
        if (metatags != null)
        {
            ltlMetaTag.Text = "<meta name='description' content='" + metatags.ds_description + "'>\n<meta name='keywords' content='" + metatags.ds_keywords + "'>";
        }
        var pagina = (from a in cnDor.TB_CONTEUDO_PAGINA_FIXA where a.ds_link == "releases.aspx" && a.id_sessao == 5 && a.id_hospital == idHosp select a).FirstOrDefault();
