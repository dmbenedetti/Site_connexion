...
<h2>Nossas Unidades</h2>
    ...
    <table cellpadding="0" cellspacing="0" width=370 align="right">
        <tr>
            ...
            <td width="210"><asp:DropDownList ID="drp_especialidade" runat="server" Height="25px" Width="200px" CssClass="selectDefault" OnPreRender="drp_especialidade_PreRender" AutoPostBack="True" OnSelectedIndexChanged="drp_especialidade_SelectedIndexChanged"></asp:DropDownList></td>
        </tr>
    </table>
