<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="releases_detail.aspx.cs" Inherits="releases_detail" %>
    ...
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="id_conteudo" 
        ...
        <ItemTemplate>
           ...
           <div style="padding:20px;" class="campanhas_front">
                ...
                </span><a href="<%# Server.UrlEncode(Eval("nm_titulo").ToString().Replace(":","_").Replace("?","")).Replace("+","_") %>,r,<%# Eval("id_conteudo") %>.aspx">
