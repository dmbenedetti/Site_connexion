...
<asp:ListView ID="ListView1" runat="server" DataKeyNames="id_conteudo" DataSourceID="ds_paginas">
            ...
            <ItemTemplate>
                ...
                <a href="<%# Server.UrlEncode(Eval("nm_titulo").ToString().Replace(":","_").Replace("?","")).Replace("+","_") %>,n,<%# Eval("id_conteudo") %>.aspx"><img src="images/noticias/<%# Eval("imagem") %>" width="85" height="80" style="float:left;margin-right:20px;"/></a>
                <%# string.Format("{0:dd/MM/yyyy}", Eval("dt_conteudo"))%>
                <h3><a href="<%# Server.UrlEncode(Eval("nm_titulo").ToString().Replace(":","_").Replace("?","")).Replace("+","_") %>,n,<%# Eval("id_conteudo") %>.aspx">
