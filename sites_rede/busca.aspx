    ...
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="id_conteudo">
        ...
        <ItemTemplate>
            <div style="border-bottom: solid 1px #efefef; margin-bottom: 20px; padding-bottom: 20px;" class="campanhas_front">
                <a href='<%# url(Eval("id_conteudo").ToString(), Convert.ToInt32(Eval("id_tipo")), Convert.ToInt32(Eval("id_sessao")), Eval("nm_titulo").ToString()) %>'>
                ...
                <h3 style="margin: 5px 0;">
                    <a href='<%# url(Eval("id_conteudo").ToString(), Convert.ToInt32(Eval("id_tipo")), Convert.ToInt32(Eval("id_sessao")), Eval("nm_titulo").ToString()) %>'><strong>
