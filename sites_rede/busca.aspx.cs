    ...
    protected string url(string id, int idTipo, int idHosp, string Titulo)
    {
        ...
        switch (idHosp)
        {
            ...
            case 5:
                switch (idTipo) {
                    case 1:
                        sURL = Titulo.Replace(":", "_").Replace("?", "").Replace(" ", "_").Replace("+", "_") + ",d," + id + ".aspx";
                        break;
                    case 5:
                        sURL = Titulo.Replace(":", "_").Replace("?", "").Replace(" ", "_").Replace("+", "_") + ",n," + id + ".aspx";
                        break;
                    case 6:
                        sURL = Titulo.Replace(":", "_").Replace("?", "").Replace(" ", "_").Replace("+", "_") + ",r," + id + ".aspx";
                        break;
                }
                break;
            case 6:
