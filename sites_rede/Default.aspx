...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="lead">
        ...
        <nav id="caption">        
          	<ul>
                <li><img class="lead_image" src="images/rsl.gif" class="<%= banner1_css %>" /></li>
                <li id="libanner"><a href="<%= banner1_link %>" <%= banner1_link.IndexOf("http") > -1 && banner1_link.IndexOf(dominio) == -1 ? "target='_blank'" : "" %>><%= banner1_desc %></a></li>
            </ul>
        </nav>
    </div>
    <div id="lead">
        ...
        <nav id="caption">        
          	<ul>
                <li><img class="lead_image" src="images/rsl.gif" class="<%= banner2_css %>" /></li>
                <li id="libanner"><a href="<%= banner2_link %>" <%= banner2_link.IndexOf("http") > -1 && banner2_link.IndexOf(dominio) == -1 ? "target='_blank'" : "" %>><%= banner2_desc %></a></li>
            </ul>
        </nav>
    </div>
    <div id="lead">
        ...
        <nav id="caption">        
          	<ul>
                <li><img class="lead_image" src="images/rsl.gif" class="<%= banner3_css %>" /></li>
                <li id="libanner"><a href="<%= banner3_link %>" <%= banner3_link.IndexOf("http") > -1 && banner3_link.IndexOf(dominio) == -1 ? "target='_blank'" : "" %>><%= banner3_desc %></a></li>
            </ul> 
        </nav>
    </div>
    <div id="lead2">
        ...
        <nav id="caption">        
          	<ul>
                <li><img class="lead_image" src="images/rsl.gif" class="<%= banner4_css %>" /></li>
                <li id="libanner"><a href="<%= banner4_link %>" <%= banner4_link.IndexOf("http") > -1 && banner4_link.IndexOf(dominio) == -1 ? "target='_blank'" : "" %>><%= banner4_desc %></a></li>
            </ul>
        </nav>
    </div>
        </div>
