   ...
   <!-- <link rel="stylesheet" href="styles/colorbox.css" />
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $.colorbox({ href: "http://www.hospitalassuncao.com.br/popup.html", open: true, iframe: true, width: "650", height: "550" });
            });-->
		</script>
    <style>
    .txt
...
<body>
    ...
    <form id="form1" runat="server" >
		        ...
		        <div id="chamadas_home2">
			        ...
			        <!-- Fim Div noticias_home -->
			           <div class="banner_home2">
			            <div class="fb-like-box" id="fb" style="display: inline-block; position: relative; clear: left; width: 210px; height: 200px;" data-href="https://www.facebook.com/hospitalassuncao" data-width="210" data-height="220" data-show-faces="true" data-border-color="#d0d0d0" data-stream="false" data-header="false"></div>
				        <%// =imagem_banner2%>
			        </div>
                ...
                <div style="z-index: 90;width: 225px; clear: both;">
                            ...
                            <div id="DivHospitais" style="z-index: 91; -moz-border-bottom-colors: none; -moz-border-image: none;
                                ...
                                padding-top: 0; position: relative; top: 3px; width: 89%; display: none;"><ul id="hosp_list">
                                    ...
                                    <li class=""><a href="http://www.hospitalbrasil.com.br/" target="_blank">- Hospital Brasil</a> </li>
        ...
        <!-- Div Rodape-->
        <div id="content_rodape" style="background:url(images/bck_rodape.gif) top center repeat-x; height:120px;">
		...
		<br /><strong>PABX:</strong>(11) 4344-8000
             <br /><br />
...
color: #666666;">
 ...
 // window.setTimeout(function () {  document.getElementById("fb").innerHTML = document.getElementById("fb").innerHTML.replace("width: 0px", "width: 164px").replace("height: 0px", "height: 182px").replace("width: 0px; height: 0px;", ""); }, 3000);
</script>
   </form>
</body>
</html>
