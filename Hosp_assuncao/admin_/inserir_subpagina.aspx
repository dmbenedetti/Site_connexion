<%@ Page Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="inserir_subpagina.aspx.cs" Inherits="admin_portal_editar_pagina" Title="Untitled Page" %>
        ...
        <b>Tipo de página:</b></p>
                                    <p>
                                        <asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="True" 
                                            ...
                                            <asp:ListItem Value="0" Selected="True">Conteúdo</asp:ListItem>
