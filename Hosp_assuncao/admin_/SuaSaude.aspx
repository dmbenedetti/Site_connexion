<%@ Page Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="SuaSaude.aspx.cs" Inherits="admin_noticias" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p>&nbsp;</p>
<h2 class="style1">Revista SuaSaúde</h2>
<p>&nbsp;</p>
                        ...
                        <ItemTemplate>
                            <td valign="top">
                                <div class="cat_produtos">
                                    ...
                                    <img height="113" src='../images/SuaSaude/<%# Eval("imagem") %>' 
                                        width="86" height="115" /><br />
			                        <br />
                                    <a href='SuaSaude_excluir.aspx?id=<%# Eval("id_dna") %>'>Excluir</a> |
                                    <a href='SuaSaude_editar.aspx?id=<%# Eval("id_dna") %>'>Editar</a>
                                </div>
                            </td>
                        </ItemTemplate>
                        <EmptyDataTemplate>
