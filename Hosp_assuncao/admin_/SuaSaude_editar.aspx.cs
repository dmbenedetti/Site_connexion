...
public partial class admin_portal_excluir_pagina : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack) {
            ...
            img.ImageUrl = "~/images/SuaSaude/" + (string)tb01.Rows[0]["imagem"];
    ...
    protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
    {
        ...
        FileInfo TheFile = new FileInfo(MapPath("../") + "/images/SuaSaude/" + nome_foto);
        delete_foto.Deletearquivo(id_pag);
        File.Delete(MapPath("../") + "/images/SuaSaude/" + nome_foto);
        File.Delete(MapPath("../") + "/images/SuaSaude/" + nome_arquivo);

        Response.Write(@"<script>alert('Edição Excluída com sucesso!');location.href='SuaSaude.aspx';</script>");
    ...
    protected void Button4_Click(object sender, EventArgs e)
    {
        ...
        Response.Write(@"<script>alert('Edição editada com sucesso!');location.href='SuaSaude.aspx';</script>");
