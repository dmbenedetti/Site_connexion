...
public partial class admin_inserir_user : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        DateTime acesso = DateTime.Today;

        //verifica se o login digitado não está sendo usado por outro usuário
        string verifica_login_digitado = verifica_login(login);
        ...
        {//se o login estiber liberado para cadastro faz as instruções abaixo.
            ...
            { //faz as instruções abaixo se as senhas forem iguais
                DataSet1TableAdapters.tb_users_admTableAdapter inserir_user = new DataSet1TableAdapters.tb_users_admTableAdapter();
                inserir_user.Insert_user(nome,email, login, senha, nivel);
                Response.Write(@"<script>alert('Usuário inserido com sucesso!');location.href='user.aspx';</script>");
