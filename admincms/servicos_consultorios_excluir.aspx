<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="servicos_consultorios_excluir.aspx.cs" Inherits="admincms_ogrupo_criar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D'or > Serviços > Consultórios Especializados > Excluir > <asp:Label ID="lbl_noticia" runat="server" Text=""></asp:Label></strong>
        
    </p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <h2>Excluir Especialidade<asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" 
