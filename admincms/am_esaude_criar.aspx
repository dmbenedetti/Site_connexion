<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="am_esaude_criar.aspx.cs" Inherits="admincms_ogrupo_criar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D'or > Área Mécida > E-Saúde 
        &gt;Novo Post</strong></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <h2>Novo E-Saúde<asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" 
