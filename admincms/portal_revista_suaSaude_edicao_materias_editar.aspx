<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="portal_revista_suaSaude_edicao_materias_editar.aspx.cs" Inherits="admincms_ogrupo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D'or > Publicações e Campanhas > Revista Sua Saúde&nbsp; &gt;&nbsp; Edição <asp:Label ID="lbl_nr_edicao" runat="server"></asp:Label>&nbsp;&gt; Editar Matéria</strong></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
