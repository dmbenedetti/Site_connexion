...
public partial class admincms_ogrupo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack) {
            ...
            var optMenu = (from a in cnDor.TB_CONTEUDO_PAGINA_FIXA where a.id_sessao == 5 && a.id_hospital == idHosp && a.ds_link == "noticias.aspx" select a).FirstOrDefault();
            if (optMenu != null)
            {
    ...
    {
        Response.Redirect("portal_noticias_criar.aspx");
    }
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (oMenuFixo == null)
        {
            ...
            oMenuFixo.ds_linkmenu = "noticias.aspx";
        }
