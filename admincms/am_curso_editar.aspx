<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="am_curso_editar.aspx.cs" Inherits="admincms_ogrupo_criar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D&#39;or &gt; Área Médica > Cursos e Palestras &gt; Editar </strong>
        
    </p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <h2>Editar <strong>Curso </strong><asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" 
    ...
    <p>
        <asp:ListBox ID="lst_especialidade" Rows="6" runat="server" CssClass="txt" SelectionMode="Multiple"></asp:ListBox>
    </p>
