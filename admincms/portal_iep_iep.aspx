<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="portal_iep_iep.aspx.cs" Inherits="admincms_ogrupo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D'or > Institutos, Estudos e Pesquisas > Instituto IEP</strong></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <h2>Instituto IEP</h2>
    <p>&nbsp;</p>
...
<p>
    ...
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="id_conteudo" DataSourceID="ds_paginas">
            ...
            <ItemTemplate>
                ...
                <p><%# Eval("ds_resumo") %></p>
                <p><a href="portal_iep_iep_editar.aspx?id=<%# Eval("id_conteudo") %>">Editar</a>&nbsp;&nbsp; | &nbsp;&nbsp;<a href="portal_iep_iep_excluir.aspx?id=<%# Eval("id_conteudo") %>">Excluir</a>
     ...
     <p>
        <asp:SqlDataSource ID="ds_paginas" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:Parameter DefaultValue="14" Name="id_tipo" Type="Int32" />
