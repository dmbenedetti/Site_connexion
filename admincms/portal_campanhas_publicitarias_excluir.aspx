<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="portal_campanhas_publicitarias_excluir.aspx.cs" Inherits="admincms_ogrupo_criar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D&#39;or &gt; o Grupo > Campanhas Publicitárias &gt; Excluir &gt; <asp:Label ID="lbl_noticia" runat="server" Text=""></asp:Label></strong>
        
    </p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <h2>Excluir Campanha Publicitária<asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" 
    ...
    <p>
        ...
        <br />
        <b>Você tem certeza que deseja excluir esta campanha?</b></p>
    <p>
