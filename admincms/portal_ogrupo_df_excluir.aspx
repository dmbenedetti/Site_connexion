<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="portal_ogrupo_df_excluir.aspx.cs" Inherits="admincms_ogrupo_criar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D'or > O Grupo > Demostrativo Financeiro &gt; Excluir &gt; <asp:Label ID="lbl_noticia" runat="server" Text=""></asp:Label></strong>
        
    </p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <h2>Excluir Demonstrativo Financeiro<asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" 
    ...
    <p>
        ...
        <br />
        <b>Você tem certeza que deseja excluir este demonstrativo?</b></p>
    <p>
