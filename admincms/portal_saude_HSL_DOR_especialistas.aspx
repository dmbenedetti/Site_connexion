<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="portal_saude_HSL_DOR_especialistas.aspx.cs" Inherits="admincms_ogrupo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D&#39;or &gt; Espaço Saúde &gt; Saúde com os Hospitais Rede 
        D’Or São Luiz&gt;Especialistas</strong></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>
        &nbsp;</p>
    ...
    <p>
        <asp:GridView ID="gdv_setor" runat="server" AutoGenerateColumns="False" 
            ...
            CellPadding="4" DataKeyNames="id_especialista" DataSourceID="ds_setor" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="nm_especialista" HeaderText="Especialista" 
                    SortExpression="nm_especialista">
        ...
        <asp:SqlDataSource ID="ds_setor" runat="server" 
            ...
            DeleteCommand="UPDATE [TB_PORTAL_ESPECIALISTA] SET [id_status] = 2 WHERE [id_especialista] = @original_id_especialista " 
            InsertCommand="INSERT INTO [TB_PORTAL_ESPECIALISTA] ([nm_especialista]) VALUES (@nm_especialista)" 
            OldValuesParameterFormatString="original_{0}" 
            SelectCommand="SELECT [id_especialista], [nm_especialista] FROM [TB_PORTAL_ESPECIALISTA] WHERE ([id_status] = @id_status) ORDER BY [nm_especialista]" 
            
            UpdateCommand="UPDATE [TB_PORTAL_ESPECIALISTA] SET [nm_especialista] = @nm_especialista WHERE [id_especialista] = @original_id_especialista ">
            <DeleteParameters>
                <asp:Parameter Name="original_id_especialista" Type="Int32" />
            </DeleteParameters>
            <InsertParameters>
                <asp:Parameter Name="nm_especialista" Type="String" />
            </InsertParameters>
            <SelectParameters>
