...
public partial class admincms_ogrupo_criar : System.Web.UI.Page
{
    ...
    protected void grava_pagina_interna() {
        ...
        try
        {
            ...
            cnDor.SaveChanges();
            ClientScript.RegisterStartupScript(this.GetType(), "sucesso", "alert('Conteúdo gravado com Sucesso!');location.href='portal_imprensa.aspx'", true);
        }
        catch (Exception ex)
        {
    ...
    protected void grava_link_interno()
    {
        ...
        try
        {
            ...
            cnDor.SaveChanges();
            ClientScript.RegisterStartupScript(this.GetType(), "sucesso", "alert('Link gravado com Sucesso!');location.href='portal_imprensa.aspx'", true);
        }
        catch (Exception ex)
        {
            ClientScript.RegisterStartupScript(this.GetType(), "erro", "alert('erro na hora de gravar o conteudo \n " + ex.Message + "')", true);
    ...
    protected void grava_formulario()
    {
        ...
        try
        {
            cnDor.AddToTB_PORTAL_CONTEUDO(novoLinkInterno);
            cnDor.SaveChanges();
            ClientScript.RegisterStartupScript(this.GetType(), "sucesso", "alert('Formulário gravado com Sucesso!');location.href='portal_imprensa.aspx'", true);
        }
        catch (Exception ex)
        {
            ClientScript.RegisterStartupScript(this.GetType(), "erro", "alert('erro na hora de gravar o conteudo \n " + ex.Message + "')", true);
