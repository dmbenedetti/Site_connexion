...
public partial class admincms_ogrupo_criar : System.Web.UI.Page
{
    ...
    int tipo = 15;//Inst Saude Publica
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            if (campanha.ds_imgDestaque == "" || campanha.ds_imgDestaque == null)
            {
                ...
                Image1.ImageUrl = "../images/iep/" + campanha.ds_imgDestaque;
            ...
            {
                filepdf.NavigateUrl = "../pdf/iep/" + campanha.ds_file;
    ...
    protected string uploadimagem(){
            ...
            string autorizado1 = "";
            string caminho = Server.MapPath("~/images/iep/");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (erro == false)
        {
            try
            {
                ...
                Response.Write(@"<script>alert('Dados Gravados com sucesso');location.href='portal_iep_saude_publica.aspx'</script>");
            }
            catch (Exception ex)
            {
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ...
        if (imagem != "" || imagem != null)
        {
            FileInfo TheFile = new FileInfo(MapPath("../") + "/pdf/iep/" + imagem);
            File.Delete(MapPath("../") + "/pdf/iep/" + imagem);
        }
        LinkButton1.Visible = false;
        filepdf.Text = "";
