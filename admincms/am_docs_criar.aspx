<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="am_docs_criar.aspx.cs" Inherits="admincms_ogrupo_criar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D'or > Área Médica > Documentos 
        &gt;Novo Documento</strong></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <h2>Novo Documento<asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" 
...
<!-- Fim Div formulario_pag-->
    <strong>Publicar este documento também nos sites:</strong><br />
