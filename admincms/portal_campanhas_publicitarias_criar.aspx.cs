...
{
    int sessao_site = 1;//Publicações e Campanhas
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (erro == false)
        {
            try
            {
                    ...
                    Response.Write(@"<script>alert('Campanha Gravada com sucesso!');location.href='portal_campanhas_publicitarias.aspx'</script>");
            }
            catch (Exception ex)
            {
