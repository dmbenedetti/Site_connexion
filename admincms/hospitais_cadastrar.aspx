<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="hospitais_cadastrar.aspx.cs" Inherits="admincms_hospitais_editar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D'or > Hospitais > Novo Hospital</strong></p>
...
<p>
    <asp:ImageButton ID="ImageButton1" runat="server" 
        ImageUrl="~/admincms/images/btn_gravar.jpg" onclick="ImageButton1_Click" 
        ValidationGroup="hospital" />
</p>
<p>
    &nbsp;</p>
<p>
