<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="portal_iep_saude_publica.aspx.cs" Inherits="admincms_ogrupo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D'or > Institutos, Estudos e Pesquisas > Instituto D'Or Gestão de Saúde Pública</strong></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
...
<p>
    ...
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="id_conteudo" DataSourceID="ds_paginas">
            ...
            <ItemTemplate>
                ...
                <p><%# Eval("ds_resumo") %></p>
                <p><a href="portal_iep_saude_publica_editar.aspx?id=<%# Eval("id_conteudo") %>">Editar</a>&nbsp;&nbsp; | &nbsp;&nbsp;<a href="portal_iep_saude_publica_excluir.aspx?id=<%# Eval("id_conteudo") %>">Excluir</a>
