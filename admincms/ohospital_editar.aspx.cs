    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack) {
            ...
            if (pagina != null)
            {
                ...
                Response.Redirect("ohospital.aspx");
            }
    ...
    protected void grava_pagina_interna(int id_conteudo) {
        try
        {
            ...
            if (pagina != null)
            {
                ...
                cnDor.SaveChanges();
                ClientScript.RegisterStartupScript(this.GetType(), "sucesso", "alert('Dados atualizados com sucesso!');location.href='ohospital.aspx'", true);
            }//fim do if pagina!=null
        }
        catch (Exception ex)
        {
