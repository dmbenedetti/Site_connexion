<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="ohospital_criar.aspx.cs" Inherits="admincms_ohospital_criar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D'or > O Hospital > Nova Página</strong></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <h2>Nova Página</h2>
    <p>&nbsp;</p>
