<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="formteste_OLD.aspx.cs" Inherits="fale_conosco" Title="Hospital e Maternidade Brasil" %>
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td height="24" class="celula_table" align="left" valign="top" class="style3" colspan="2">
                ...
                Unidade Brasil | Tel.: (11) 2127-6574
                <br />
                <p>
                    <strong><span>Horário de atendimento: Todos os dias, das 7h às 22h</span></strong></p>
                <br />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td height="24" class="style12" align="left" valign="top" class="style3">
                Paciente alérgico a latex:*<asp:RequiredFieldValidator 
                    ID="RequiredFieldValidator36" runat="server" 
                    ControlToValidate="rdo_Alergico_latex" ErrorMessage="[">*</asp:RequiredFieldValidator>
            </td>
            <td height="24" class="celula_table" align="left" valign="top">
                    ...
                    <asp:Repeater ID="rptMateriais" runat="server">
                        <ItemTemplate>
                            <tr>
                                <td class="style9" height="24">
                                    <%# Eval("id") %>°&nbsp;&nbsp;
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Materiais especiais / OPME" ControlToValidate="txt_MateriaisEspeciais" Text="*"></asp:RequiredFieldValidator>
                                    <asp:TextBox ID="txt_MateriaisEspeciais" runat="server" CssClass="txt" Height="18px"
                                        Width="150px" Text='<%# Eval("cod") %>'></asp:TextBox>
                                </td>
                                <td class="style10">
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="Preencha o campo fornecedor" ControlToValidate="txt_Fornecedor" Text="*"></asp:RequiredFieldValidator>
                                    <asp:TextBox ID="txt_Fornecedor" runat="server" CssClass="txt" Height="18px" Width="200px"
                                        Text='<%# Eval("fornecedor") %>'></asp:TextBox>
                                </td>
                                <td>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ErrorMessage="Preencha o campo quantidade" ControlToValidate="txt_materiaisQtde" Text="*"></asp:RequiredFieldValidator>
                ...
                <table cellpadding="0" cellspacing="0" class="style1">
                    ...
                    <tr>
                        <td class="style2" class="celula_table" valign="top">
                            ...
                            entre em contato:<br />
                            <br />
                            <strong>Central de Autorizações:</strong> segunda a sexta-feira, das 7h às 19h<br />
                            Unidade Brasil | Tel.: (11) 2127-6872 | Fax: (11) 2127-6387 | email: acirurgico@hospitalbrasil.com.br<br />
                            <br />
                            <strong>Central de Reservas:</strong> todos os dias, das 7h às 22h
                            <br />
                            Tel.: (11) 3040-1300 | Fax: (11) 3040-9393 | e-mail: cirurgia@saoluiz.com.br
                            <br />
                            <br />
                            <strong>Agendamento cirurgico:</strong> todos os dias, das 7h às 22h
                            <br />
                            Tel.: (11) 2127-6574
                            <br />
                            <br />
