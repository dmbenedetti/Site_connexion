<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="editPage.aspx.cs" Inherits="admin_editPage" %>
...
<h2>Editar Página: 
    ...
    <p>
        &nbsp;</p>
    <p>
        <input id="Button1" class="txt" onclick="javascript: history.go(-1)" 
            type="button" value="« Voltar" /><br />
    </p>
</asp:Content>
