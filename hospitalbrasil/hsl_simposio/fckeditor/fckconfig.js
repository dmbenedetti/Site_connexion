...
FCKConfig.ToolbarSets["Basico2"] = [
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','Bold','Italic','Underline','StrikeThrough','OrderedList','UnorderedList','Image','Flash','Table','Source'],
	'/',
	['Style','Cut','Copy','Paste', '-','Undo','Redo','Link','Unlink','SpecialChar','RemoveFormat'],
] ;
...
FCKConfig.CustomStyles =
{
	...
	'Destaque'	: { Element : 'sapn', Styles : { 'font':'bold 12px Arial, Helvetica, sans-serif','color':'#4E6F97' } }
};
