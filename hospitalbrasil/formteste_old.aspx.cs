...
public partial class fale_conosco : System.Web.UI.Page
{
    ...
    protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string email = "avolcian@saoluiz.com.br";
        string email_to = "avolcian@saoluiz.com.br";
        //string email_to = "rhselecao@hospitalassuncao.com.br";
        string email_from = "avolcian@saoluiz.com.br";

        string ip = "";
        IPAddress[] addressList = Dns.GetHostByName(Dns.GetHostName()).AddressList;
        for (int i = 0; i < addressList.Length; i++) ip += addressList[i].ToString() + "\n";

        string bodyhtml = "<table width=100% border=1 bordercolor=#000099 cellspacing=0 cellpadding=5><tr><td width=30%><img src='http://www.hospitalbrasil.com.br/images/logo.jpg' width=80% /></td><td valign=baseline align='center'><H2><strong><font color=#000099>Aviso de Cirurgia</font></strong></H2></td></tr></table>";
        ...
        mensagem.Subject = "Aviso de Cirurgia - Site Unidade Brasil - " + rdo_tipoCirurgia.SelectedValue;
