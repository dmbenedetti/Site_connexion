<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_am.master" AutoEventWireup="true" CodeFile="am_cursos.aspx.cs" Inherits="campanhas" %>
            ...
            <ItemTemplate>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td width="180" class="curso1" style="border-left: 1px solid #efefef; border-right: 1px solid #efefef; text-align:center;">
                            <%# Eval("nm_hospital") %>
                        </td>
                        <td width="200" class="curso2" style=" text-align:center;">
                            <div class='<%#((!Convert.IsDBNull(Eval("dt_inscricao"))) && System.DateTime.Now < Convert.ToDateTime(Eval("dt_inscricao")) ? "btnPrimario" : "botao2") %>'><asp:HyperLink ID="hpkInscricao" runat="server" Text='<%# ((!Convert.IsDBNull(Eval("dt_inscricao"))) && System.DateTime.Now < Convert.ToDateTime(Eval("dt_inscricao")) ? "Saiba mais" : "<strong>Inscrições encerradas</strong>") %>' NavigateUrl='<%# "am_curso_detail.aspx?id=" + Eval("id").ToString() %>'></asp:HyperLink></span>
                        </td>
                    </tr>
                </table>
             </div>
