...
public partial class admincms_ogrupo_criar : System.Web.UI.Page
{
    ...
    int tipo = 4;//campanhas Publicitárias
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            {
                Image1.ImageUrl = "../images/campanhas_publicitarias/destaque_default.jpg";
                LinkButton1.Visible = false;
            } else {
                Image1.ImageUrl = "../images/campanhas_publicitarias/" + campanha.ds_imgDestaque;
    ...
    protected string uploadimagem(){
            ...
            string autorizado1 = "";
            string caminho = Server.MapPath("~/images/campanhas_publicitarias/");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (erro == false)
        {
            try
            {
                ...
                campanha.ds_conteudo = FCKeditor1.Value;
                ...
                Response.Write(@"<script>alert('Dados Gravados com sucesso');location.href='portal_campanhas_publicitarias.aspx'</script>");
            }
            catch (Exception ex)
            {
