<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="portal_imprensa.aspx.cs" Inherits="admincms_ogrupo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D'or > Imprensa </strong></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <h2>Imprensa</h2>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:HyperLinkField 
                    DataTextField="metatag" Text="Meta Tags">
...
<p>
    ...
    <p>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:BoundField DataField="nm_titulo" HeaderText="Página Dinâmicas" 
                    SortExpression="nm_titulo">
                <HeaderStyle Height="30px" HorizontalAlign="Left" Width="400px" />
                <ItemStyle Height="30px" />
                </asp:BoundField>
                <asp:HyperLinkField DataNavigateUrlFields="id_conteudo" 
                    DataNavigateUrlFormatString="adm_metatags_editar.aspx?id_conteudo={0}&r=6" Text="Meta Tags">
                <ItemStyle HorizontalAlign="Center" Width="70px" />
                </asp:HyperLinkField>
                <asp:HyperLinkField DataNavigateUrlFields="id_conteudo" 
                    DataNavigateUrlFormatString="portal_imprensa_editar.aspx?id={0}" 
                    Text="Editar">
                <ItemStyle HorizontalAlign="Center" Width="70px" />
                </asp:HyperLinkField>
        ...
        <asp:SqlDataSource ID="ds_paginas" runat="server" 
            ...
            SelectCommand="SELECT [id_conteudo], [nm_titulo] FROM [TB_PORTAL_CONTEUDO] WHERE (([id_status] = @id_status) AND ([id_idioma] = @id_idioma) AND ([id_sessao] = @id_sessao) AND ([id_tipo] = @id_tipo) AND (id_hospital = @id_hospital))" 
