<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="portal_releases_excluir.aspx.cs" Inherits="admincms_ogrupo_criar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D&#39;or &gt; Imprensa &gt; Releases &gt; Excluir &gt; <asp:Label ID="lbl_noticia" runat="server" Text=""></asp:Label></strong>
        
    </p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <h2>Excluir Release<asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" 
    ...
    <p>
        ...
        <br />
        <b>Você tem certeza que deseja excluir este Release?</b></p>
    <p>
    ...
    <p>
        &nbsp;</p>
    <p>
        Excluir este Release em todos os hospitais abaixo?<asp:RadioButtonList 
