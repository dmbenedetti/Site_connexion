<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="servico.aspx.cs" Inherits="admincms_servico" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D'or > Serviços </strong></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <h2>Serviços</h2>
    <p>&nbsp;</p>
...
<p>
    <asp:Button ID="Button1" runat="server" BackColor="#666666" Font-Bold="True" 
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:HyperLinkField 
                    NavigateUrl="adm_metatags_editar.aspx?r=4&pagina=corpo_clinico.aspx" Text="Meta Tags">
    ...
    <p>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="id_conteudo" 
                    DataNavigateUrlFormatString="adm_metatags_editar.aspx?id_conteudo={0}&r=5" Text="Meta Tags">
                <ItemStyle HorizontalAlign="Center" Width="70px" />
                </asp:HyperLinkField>
                <asp:HyperLinkField DataNavigateUrlFields="id_conteudo" 
                    DataNavigateUrlFormatString="servico_editar.aspx?id={0}" Text="Editar">
                <ItemStyle HorizontalAlign="Center" Width="70px" />
                </asp:HyperLinkField>
        ...
        <asp:SqlDataSource ID="ds_paginas" runat="server" 
            ...
            SelectCommand="SELECT [id_conteudo], [nm_titulo] FROM [TB_PORTAL_CONTEUDO] WHERE (([id_status] = @id_status) AND ([id_idioma] = @id_idioma) AND ([id_sessao] = @id_sessao) AND id_hospital = @idHosp AND id_tipo IN (1, 2, 3, 10, 11))" 
            ...
            <SelectParameters>
                ...
                <asp:Parameter DefaultValue="9" Name="id_sessao" Type="Int32" />
            </SelectParameters>
            <UpdateParameters>
                <asp:Parameter Name="nm_titulo" Type="String" />
                <asp:Parameter Name="id_conteudo" Type="Int32" />
