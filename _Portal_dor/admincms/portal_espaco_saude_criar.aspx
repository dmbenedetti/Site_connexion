<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="portal_espaco_saude_criar.aspx.cs" Inherits="admincms_ogrupo_criar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D'or > Espaço Saúde > Nova Página</strong></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <h2>Nova Página</h2>
    <p>&nbsp;</p>
