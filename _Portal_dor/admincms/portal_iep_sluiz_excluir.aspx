<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="portal_iep_sluiz_excluir.aspx.cs" Inherits="admincms_ogrupo_criar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D&#39;or &gt; Institutos, Estudos e Pesquisas > Centro de Estudos São Luiz &gt; Excluir &gt; <asp:Label ID="lbl_noticia" runat="server" Text=""></asp:Label></strong>
