<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="portal_faleConosco.aspx.cs" Inherits="admincms_ogrupo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D'or > Fale Conosco </strong></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <h2>Fale Conosco</h2>
    <p>&nbsp;</p>
...
<p>
    ...
    <p>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="id_conteudo" 
                    DataNavigateUrlFormatString="portal_faleConosco_editar.aspx?id={0}" 
                    Text="Editar">
        ...
        <asp:SqlDataSource ID="ds_paginas" runat="server" 
            ...
            SelectCommand="SELECT [id_conteudo], [nm_titulo] FROM [TB_PORTAL_CONTEUDO] WHERE (([id_status] = @id_status) AND ([id_idioma] = @id_idioma) AND ([id_sessao] = @id_sessao) AND id_hospital = @idHosp)" 
            ...
            <SelectParameters>
                ...
                <asp:Parameter DefaultValue="6" Name="id_sessao" Type="Int32" />
            </SelectParameters>
            <UpdateParameters>
                <asp:Parameter Name="nm_titulo" Type="String" />
                <asp:Parameter Name="id_conteudo" Type="Int32" />
