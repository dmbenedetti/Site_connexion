...
public partial class admincms_ogrupo_criar : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack) {
            ...
            DropDownList1.DataSource = cnDor.TB_FORMULARIOS.Where(x => x.id_hospital == idHosp && x.id_status == 1).Select(x => new { x.id_formulario, x.nm_formulário }).ToList();
            ...
            if (pagina != null)
            {
                ...
                Response.Redirect("portal_faleConosco.aspx");
            }
    ...
    protected void grava_pagina_interna(int id_conteudo) {
        try
        {
            ...
            if (pagina != null)
            {
                ...
                cnDor.SaveChanges();
                ClientScript.RegisterStartupScript(this.GetType(), "sucesso", "alert('Dados atualizados com sucesso!');location.href='portal_faleConosco.aspx'", true);
            }//fim do if pagina!=null
        }
        catch (Exception ex)
        {
