<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="usuarios_criar.aspx.cs" Inherits="admincms_usuarios_criar" %>
...
<p></p>
    <p>
        &nbsp;</p>
            ...
            <table border="0" cellpadding="4">
                ...
                <tr>
                    <td align="left" class="style5" height="30" valign="middle">
                        Senha:<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                            ControlToValidate="txt_senha" ErrorMessage="Campo senha é obrigatório" 
                            ForeColor="Red" ValidationGroup="Usuario">*</asp:RequiredFieldValidator>
                ...
                <tr>
                    <td align="left" class="style5" height="30" valign="middle">
                        Confirmar Senha:<asp:RequiredFieldValidator ID="RequiredFieldValidator5" 
                            runat="server" ControlToValidate="txt_senha_confirm" 
                            ErrorMessage="Campo confirmar senha é obrigatório" ForeColor="Red" 
                    ...
                    <td class="style4">
                          <table width="800" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                ...
                                <td width="400">
                                    <b>Menu Portal:</b><br />
                                    <asp:CheckBox ID="chk2All" Text="Todos" runat="server" />
                                    <asp:CheckBoxList ID="chk_menus_portal" runat="server">
                                    </asp:CheckBoxList>
                                    <br /><br />
                                    <b>Menu Hospitais:</b><br />
                                    <asp:CheckBox ID="chk3All" Text="Todos" runat="server" />
                                    <asp:CheckBoxList ID="chk_menus_hospitais" runat="server">
                                    </asp:CheckBoxList>
                                </td>
                            </tr>
                        </table>
    ...
    <asp:Button ID="btn_gravar" runat="server" BackColor="#666666" Enabled="False" Font-Bold="True" ForeColor="White" Height="25px" onclick="btn_gravar_Click" Text="Gravar" ValidationGroup="Usuario" Width="95px" />
                    </td>
                </tr>
            </table>
