<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="portal_campanhas_publicitarias.aspx.cs" Inherits="admincms_ogrupo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D'or > o Grupo > Campanhas Publicitárias</strong></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
...
<p>
    <asp:Button ID="Button1" runat="server" BackColor="#666666" Font-Bold="True" 
        ForeColor="White" Height="30px" Text="Nova Campanha" Width="153px" 
    ...
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="id_conteudo" DataSourceID="ds_paginas">
            ...
            <ItemTemplate>
                ...
                <img src="../images/campanhas_publicitarias/<%# Eval("imagem") %>" width="85" height="80" style="float:left;margin:5px;"/>
                <p><%# string.Format("{0:dd/MM/yyyy}", Eval("dt_conteudo"))%> - <span style="font:bold 16px; margin:5px 0;"><strong><%# Eval("nm_titulo") %></strong></span></p>
                <p><%# Eval("ds_resumo") %></p>
                <p><a href="portal_campanhas_publicitarias_editar.aspx?id=<%# Eval("id_conteudo") %>">Editar</a>&nbsp;&nbsp; | &nbsp;&nbsp;<a href="portal_campanhas_publicitarias_excluir.aspx?id=<%# Eval("id_conteudo") %>">Excluir</a>
