<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="area_medica.aspx.cs" Inherits="admincms_iep" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <p><strong>Portal Rede D'or > Área Médica </strong></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <h2>Área Médica</h2>
    <p>&nbsp;</p>
...
<p>
    ...
    <p>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="id_conteudo" 
                    DataNavigateUrlFormatString="adm_metatags_editar.aspx?id_conteudo={0}&r=7" Text="Meta Tags">
                <ItemStyle HorizontalAlign="Center" Width="70px" />
                </asp:HyperLinkField>
                <asp:HyperLinkField DataNavigateUrlFields="id_conteudo" 
                    DataNavigateUrlFormatString="am_editar.aspx?id={0}" Text="Editar">
                <ItemStyle HorizontalAlign="Center" Width="70px" />
                </asp:HyperLinkField>
        ...
        <asp:SqlDataSource ID="ds_paginas" runat="server" 
            ...
            SelectCommand="SELECT [id_conteudo], [nm_titulo] FROM [TB_PORTAL_CONTEUDO] WHERE (([id_status] = @id_status) AND ([id_idioma] = @id_idioma) AND ([id_sessao] = @id_sessao) AND id_hospital = @idHosp) And id_tipo not in (13,14,15,16)" 
