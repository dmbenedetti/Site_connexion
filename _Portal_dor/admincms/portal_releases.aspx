<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="portal_releases.aspx.cs" Inherits="admincms_ogrupo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D'or > Imprensa > Releases</strong></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <h2>Releases</h2>
    <p>&nbsp;</p>
...
<p>
    <asp:Button ID="Button1" runat="server" BackColor="#666666" Font-Bold="True" 
        ForeColor="White" Height="30px" Text="Novo Release" Width="110px" 
    ...
    <p>
        ...
        &nbsp;<asp:ListView ID="ListView1" runat="server" DataKeyNames="id_conteudo" DataSourceID="ds_paginas">
            ...
            <ItemTemplate>
                ...
                <p><%# Eval("ds_resumo") %></p>
                <p><a href="adm_metatags_editar.aspx?id_conteudo=<%# Eval("id_conteudo") %>&r=2">Meta Tags</a>&nbsp;&nbsp; | &nbsp;&nbsp;<a href="portal_releases_editar.aspx?id=<%# Eval("id_conteudo") %>&id_not=<%# Eval("id_noticia") %>">Editar</a>&nbsp;&nbsp; | &nbsp;&nbsp;<a href="portal_releases_excluir.aspx?id=<%# Eval("id_conteudo") %>&id_not=<%# Eval("id_noticia") %>"">Excluir</a>
