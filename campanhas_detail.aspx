<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_grupo.master" AutoEventWireup="true" CodeFile="campanhas_detail.aspx.cs" Inherits="campanhas" %>
...
<h3>
    ...
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="id_conteudo" 
        ...
        <LayoutTemplate>
            <table runat="server" class="list_detail">
                <tr runat="server">
                    <td runat="server">
