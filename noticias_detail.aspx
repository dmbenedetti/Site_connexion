<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_imprensa.master" AutoEventWireup="true" CodeFile="noticias_detail.aspx.cs" Inherits="noticias_detail" %>
    ...
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="id_conteudo" 
        ...
        <ItemTemplate>
           ...
           <div style="padding:20px;" class="campanhas_front">
                <a href="noticias_detail.aspx?id=<%# Eval("id_conteudo") %>"><img src="images/noticias/<%# Eval("imagem") %>" width="85" height="80" style="float:left;margin:5px;"/></a>
                <%# string.Format("{0:dd/MM/yyyy}", Eval("dt_conteudo"))%><br />
                <h3><a href="noticias_detail.aspx?id=<%# Eval("id_conteudo") %>"><strong><%# Eval("nm_titulo") %></strong></a></h3>
                <p><a href="noticias_detail.aspx?id=<%# Eval("id_conteudo") %>"><%# Eval("ds_resumo") %></a></p>
