...
<div id="titulo_pag">
        ...
        ErrorMessage="Preencha o campo sobrenome.">*</asp:RequiredFieldValidator>
                    ...
                    <td class="style1" valign=top>
                      <asp:TextBox ID="txtSobrenome" runat="server" CssClass="text_field"></asp:TextBox>
                      </td>
                  </tr>
                  <tr>
        ...
        ErrorMessage="Preencha o campo email.">*</asp:RequiredFieldValidator>
                  ...
                  <tr>
                    ...
                    <td class="style1" valign=top>
                      <asp:TextBox ID="txtEmpresa" runat="server" CssClass="text_field"></asp:TextBox>
                      </td>
                  </tr>
                  <tr>
                    ...
                    <td class="style1" valign=top>
                      <asp:TextBox ID="txtRG" runat="server" CssClass="text_field"></asp:TextBox>
                      </td>
                  </tr>
                  <tr>
                    ...
                    <td class="style1" valign=top>
                      <asp:TextBox ID="txtCPF" runat="server" CssClass="text_field"></asp:TextBox>
                      </td>
                  </tr>
                  <tr>
                    ...
                    <td class="style1" valign=top>
                      <asp:TextBox ID="txtPassaport" runat="server" CssClass="text_field"></asp:TextBox>
                      </td>
                  </tr>
                  <tr>
