    ...
    <div id="container_interna">
        ...
        <h1>Espaço Baby</h1>
            <div id="bbsearch_Campos">
                ...
                <div id="bbsearch_Campos_Div">
            	    Nome do Bebê<br />
            	    <asp:TextBox ID="txtNomeBebe" runat="server" CssClass="inputDefault" /> <img onclick="window.open('http://www.oestedor.com.br/dynamic_page.aspx?id=1582', 'ajudafotobebe');" style="cursor:pointer;" src="images/help_bebe.jpg" title="Clique no ícone para ver  guia de uso do espaço baby" name="Clique no ícone para ver  guia de uso do espaço baby" alt="Clique no ícone para ver  guia de uso do espaço baby" /> 
                ...
                <ItemTemplate>
                    <div id="bbsearch_Item">
        	            <div id="bbsearch_imagem">
            	            <img src="images/foto_bebe/thumb/<%# Eval("ds_foto_thumb")%>" />
                        </div>
