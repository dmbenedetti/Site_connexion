...
<div id="titulo_pag">
                    ...
                    <td class="celula_table" valign=top colspan="2">
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                ...
                                <td width="168" align=left>&nbsp;&nbsp;&nbsp;&nbsp;Unidade</td>
                                <td align=left>&nbsp;&nbsp;&nbsp;&nbsp;Departamento</td>
                            </tr>
                            <tr>
                                <td width="133"><asp:DropDownList ID="drpEstado" AutoPostBack="true" CausesValidation="false" runat="server" CssClass="text_field" DataSourceID="ds_estados" DataTextField="ds_uf_sigla" DataValueField="ds_uf_sigla"></asp:DropDownList><br /><br /></td>
                                <td align="left" style="padding-left:10px;"><asp:DropDownList ID="drpUnidade" runat="server" CssClass="text_field" DataSourceID="ds_hospital" DataTextField="nm_hospital" DataValueField="nm_hospital"></asp:DropDownList><br /><br /></td>
                                <td width="116"><asp:DropDownList ID="drpDepartamento" runat="server" CssClass="text_field">
        ...
        onclick="ImageButton1_Click" />
              ...
              <div style="width: 400px; float:right;"><asp:Literal ID="ltlMapa" runat="server"></asp:Literal></div>
  </div>
