<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="am_revistas_detalhe.aspx.cs" Inherits="campanhas" %>
    ...
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="id_conteudo" 
        ...
        <ItemTemplate>
           ...
           <div class="campanhas_front">
                <a href="<%# Server.UrlEncode(Eval("nm_titulo").ToString().Replace(":","_").Replace("?","")).Replace("+","_") %>,amr,<%# Eval("id_conteudo") %>.aspx"><img src="images/sua_saude/<%# Eval("imagem") %>" width="85" height="80" style="float:left;margin:5px;"/></a>
                <%# string.Format("{0:dd/MM/yyyy}", Eval("dt_conteudo"))%><br />
                <h3 style="margin:5px 0;"><a href="<%# Server.UrlEncode(Eval("nm_titulo").ToString().Replace(":","_").Replace("?","")).Replace("+","_") %>,amr,<%# Eval("id_conteudo") %>.aspx">
