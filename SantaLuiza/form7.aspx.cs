...
public partial class fale_conosco : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lbl_titulo.Text = "Mensagem para um amigo internado";//paginas.nm_titulo;
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string email = txtSeuEmail.Text;
        string quarto = txtNumeroQuarto.Text;
        ...
        string mailbody = "<H2>Mensagem para um amigo internado - " + site + "</H2>";
        mailbody = mailbody + "<strong>Nome do pasciente: </strong>" + nome + "<br />";
        mailbody = mailbody + "<strong>Número do quarto: </strong>" + quarto + "<br />";
        mailbody = mailbody + "<strong>Nome do amigo: </strong>" + SeuNome + "<br />";
        mailbody = mailbody + "<strong>E-mail do amigo: </strong>" + email + "<br />";
        mailbody = mailbody + "<strong>Mensagem: </strong><p>" + msg + "</p><br />";
