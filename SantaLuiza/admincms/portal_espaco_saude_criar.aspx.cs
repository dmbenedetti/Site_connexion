...
{
    int sessao_site = 3;//espaço saúde
    ...
    protected void grava_pagina_interna() {
        ...
        try
        {
            ...
            cnDor.SaveChanges();
            ClientScript.RegisterStartupScript(this.GetType(), "sucesso", "alert('Conteúdo gravado com Sucesso!');location.href='portal_espaco_saude.aspx'", true);
        }
        catch (Exception ex)
        {
    ...
    protected void grava_link_interno()
    {
        ...
        try
        {
            ...
            cnDor.SaveChanges();
            ClientScript.RegisterStartupScript(this.GetType(), "sucesso", "alert('Link gravado com Sucesso!');location.href='portal_espaco_saude.aspx'", true);
        }
        catch (Exception ex)
        {
            ClientScript.RegisterStartupScript(this.GetType(), "erro", "alert('erro na hora de gravar o conteudo \n " + ex.Message + "')", true);
    ...
    protected void grava_formulario()
    {
        ...
        novoLinkInterno.nm_titulo = txt_titulo.Text;
        novoLinkInterno.ds_resumo = txt_resumo.Text;
        novoLinkInterno.ds_url = DropDownList1.SelectedValue;
        novoLinkInterno.ds_visivel = visivel;
        novoLinkInterno.id_status = 1;
        novoLinkInterno.id_sessao = sessao_site;
        novoLinkInterno.id_idioma = idioma;
        ...
        try
        {
            cnDor.AddToTB_PORTAL_CONTEUDO(novoLinkInterno);
            cnDor.SaveChanges();
            ClientScript.RegisterStartupScript(this.GetType(), "sucesso", "alert('Formulário gravado com Sucesso!');location.href='portal_espaco_saude.aspx'", true);
        }
        catch (Exception ex)
        {
            ClientScript.RegisterStartupScript(this.GetType(), "erro", "alert('erro na hora de gravar o conteudo \n " + ex.Message + "')", true);
