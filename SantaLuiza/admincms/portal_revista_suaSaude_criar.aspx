<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="portal_revista_suaSaude_criar.aspx.cs" Inherits="admincms_ogrupo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D'or > Publicações e Campanhas > Revista Sua Saúde&nbsp; &gt; Nova Edição</strong></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <h2>Nova Edição</h2>
    <p>&nbsp;</p>
...
<p>
    ...
    <p>
        <b>Arquivo PDF: 
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="FileUpload1" ErrorMessage="Escolha o arquvo PDF da edição" ForeColor="Red" ValidationGroup="suaSaude">*</asp:RequiredFieldValidator>
        </b>
    </p>
    <p>
    ...
    <p>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
            ...
            ErrorMessage="Escolha o arquvo para imagem da capa" ForeColor="Red" 
            ValidationGroup="suaSaude">*</asp:RequiredFieldValidator>
        </b>
    </p>
    <p>
    ...
    <p>
        &nbsp;</p>
    <p>
        <asp:Button ID="Button1" runat="server" BackColor="#666666" Font-Bold="True" ForeColor="White" Height="35px" Text="Avançar &gt;&gt;" OnClick="Button1_Click" ValidationGroup="suaSaude" />
    </p>
    <p>&nbsp;</p>
    <p>
        &nbsp;</p>
