<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="portal_saude_sua_saude_criar.aspx.cs" Inherits="admincms_ogrupo_criar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D'or > Saúde > Sua Saúde 
        &gt;Novo Post</strong></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <h2>Novo Post de Sua Saúde<asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" 
