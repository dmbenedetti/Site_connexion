<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="iep_criar.aspx.cs" Inherits="admincms_ogrupo_criar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D'or > Institutos, Estudos e Pesquisas > Nova Página</strong></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <h2>Nova Página</h2>
    <p>&nbsp;</p>
    ...
    <div id="formulario_pag" <% =div_formulario %>="">
        ...
        <p>
            <asp:DropDownList ID="DropDownList1" runat="server" CssClass="txt" 
                ...
                DataTextField="nm_formulário" DataValueField="ds_arquivo" 
                onprerender="DropDownList1_PreRender">
            </asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ConnectionString="<%$ ConnectionStrings:db_rede_dorConnectionString %>" 
                SelectCommand="SELECT nm_formulário, ds_arquivo FROM dbo.TB_FORMULARIOS WHERE (id_status = @id_status) AND (id_hospital = @id_hospital)">
                <SelectParameters>
