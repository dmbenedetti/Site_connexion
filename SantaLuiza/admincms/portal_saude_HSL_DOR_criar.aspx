<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="portal_saude_HSL_DOR_criar.aspx.cs" Inherits="admincms_ogrupo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D'or > Espaço Saúde > Saúde com os 
        Hospitais Rede D’Or São Luiz &gt; Novo Audio</strong></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <h2>Novo Áudio</h2>
    <p>&nbsp;</p>
...
<p>
    ...
    <asp:Label ID="lbl_erro" runat="server" ForeColor="Red"></asp:Label>
        ...
        <table class="style2">
            ...
            <tr>
                <td class="style3" height="30">
                    Audio:<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ControlToValidate="FileUpload1" ErrorMessage="Escolha um arquivo" 
                        ForeColor="Red" ValidationGroup="saude">*</asp:RequiredFieldValidator>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DropDownList1" runat="server" CssClass="txt" 
                        DataSourceID="SqlDataSource1" DataTextField="nm_tema" 
                        DataValueField="id_tema" onprerender="DropDownList1_PreRender">
                    </asp:DropDownList>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DropDownList2" runat="server" CssClass="txt" 
                        ...
                        DataValueField="id_especialista" onprerender="DropDownList2_PreRender">
                    </asp:DropDownList>
