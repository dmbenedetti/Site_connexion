    ...
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="id_foto" DataSourceID="ds_paginas">
     ...
     <p>
        <asp:SqlDataSource ID="ds_paginas" runat="server" 
            ...
            SelectCommand="SELECT [id_foto],[dt_nascimento],[dt_cadastro],[ds_nome_mae],[ds_nome_pai],[ds_nome_bebe],[nu_peso] ,[nu_estatura],[ds_obstreta],[ds_pediatra],[id_hospital],[ds_foto_bebe],[ds_foto_retrato],[ds_foto_thumb],[fg_status] FROM [db_rede_dor].[dbo].[TB_FOTO_BEBE] ORDER BY dt_cadastro DESC">
        </asp:SqlDataSource>
</p>
</asp:Content>
