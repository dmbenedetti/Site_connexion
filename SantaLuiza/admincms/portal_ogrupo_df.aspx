...
<p>
    ...
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="idDemostrativo" DataSourceID="ds_paginas">
            ...
            <ItemTemplate>
                ...
                <p><span style="font:bold 16px; margin:5px 0;"><strong><%# Eval("dsDemostrativo")%></strong></p>
     ...
     <p>
        <asp:SqlDataSource ID="ds_paginas" runat="server" 
            ...
            SelectCommand="SELECT [idDemostrativo], [dsDemostrativo] FROM [TB_DEMOSTRATIVO_FINANCEIRO] WHERE ([idStatus] = @id_status) order by dsDemostrativo asc">
            <SelectParameters>
