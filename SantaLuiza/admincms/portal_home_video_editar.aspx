<%@ Page Title="" Language="C#" MasterPageFile="~/admincms/MasterPage.master" AutoEventWireup="true" CodeFile="portal_home_video_editar.aspx.cs" Inherits="admincms_portal_home_video_editar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p><strong>Portal Rede D&#39;or &gt; Home > Videos YouTube &gt; Excluir </strong>
        
    </p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <h2>Excluir <strong>Video YouTube </strong><asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" 
