...
public partial class admincms_hospitais_especialidades : System.Web.UI.Page
{
    ...
    protected void btnGravar_Click(object sender, EventArgs e)
    {
        ...
        foreach (var menuordem in cnDor.TB_PORTAL_MENU_ORDEM.Where(a => a.id_sessao == idSessao && a.id_hospital == idHosp))
        {
        ...
        foreach (System.Web.UI.WebControls.GridViewRow iTem in gdv_especialidade.Rows)
        {
            ...
            cnDor.AddToTB_PORTAL_MENU_ORDEM(new db_rede_dorModel.TB_PORTAL_MENU_ORDEM() { id_pagina = idPagina, id_sessao = idSessao, id_tipo = idTipo, nu_ordem = nuOrdem, id_hospital = idHosp });
        }
        cnDor.SaveChanges();
    }
